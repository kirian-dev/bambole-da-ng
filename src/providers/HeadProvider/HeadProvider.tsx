...
The component is a wrapper-width component that surrounds the Head component and provides a NextProgressBar for indicating the loading progress of the web page.
