...
export const SectionTestimonials: FC = () => {
	return (
		<section className='w-full flex items-center justify-center bg-[#47694f]'>
			<div className=" wrapper-width px-4 py-16 sm:px-6 sm:py-24 lg:mr-0 lg:pl-8 lg:pr-0">
				...
				<div className="mt-8 flex justify-center gap-4 lg:hidden">
					<button
						...
						className="prev-button rounded-full border border-green-600 p-4 text-green-600 hover:bg-green-600 hover:text-white"
					>
						<svg
							className="h-5 w-5 -rotate-180 transform"
							fill="none"
					...
					<button
						...
						className="next-button rounded-full border border-green-600 p-4 text-green-600 hover:bg-green-600 hover:text-white"
					>
						<svg
							className="h-5 w-5"
							fill="none"
